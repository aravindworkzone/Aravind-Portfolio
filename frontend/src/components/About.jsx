...
const facts = [
  {
    num: "01",
    text: (<>Built a <span className="text-[#1a56e8]">SaaS with JWT refresh token rotation</span> and reuse detection — focused on keeping people's sessions genuinely secure.</>),
  },
  {
    num: "02",
  ...
  {
    num: "03",
    text: (<>Everything I build is <span className="text-[#1a56e8]">deployed and publicly accessible</span> — so anyone can explore the real, working apps.</>),
  },
];
...
export default function About() {
  ...
  return (
    <section id="about" className="py-24 md:py-32" style={{ background: "#fafaf8", fontFamily: "'DM Sans', sans-serif" }}>
        ...
        <div className={`grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24 items-start ${reveal.className}`}>
          ...
          <div>
            ...
            <p className="text-[15px] text-[#6b6860] leading-[1.85] mb-4">
              I'm a Full-Stack MERN Developer based in Tiruppur, India — self-taught and happiest when building real, deployed applications that solve genuine problems. I work across the stack with React, Node.js, MongoDB, and TypeScript — from JWT auth systems with refresh token rotation to AI-integrated backends and role-based access control.
            </p>
          ...
          <div>
            {facts.map((f, i) => (
              <div key={f.num} className="flex gap-5 py-5"
                style={{ borderTop: i === 0 ? "1px solid #ece8e1" : "none", borderBottom: "1px solid #ece8e1" }}>
