...
const items = [
  ...
  },
  {
    ...
    body: "Gemini-powered routine generation with controlled prompts and strict JSON parsing — turning yearly goals into gentle, actionable daily plans.",
    tag: "AI · Gemini",
  },
  {
    icon: (
    ...
    title: "Deployed and in use",
    body: "Every project is publicly deployed on Vercel and Render — real, working links you're warmly welcome to open and explore anytime.",
    tag: "2 live apps",
  },
];
...
function Card({ item, index }) {
  ...
  return (
    <div
      className="rounded-3xl p-7 md:p-8 cursor-default h-full"
      style={{
        background: "white",
        border: `1px solid ${hovered ? "rgba(26,86,232,0.28)" : "#ece8e1"}`,
        boxShadow: hovered ? "0 16px 40px rgba(26,86,232,0.08)" : "0 4px 16px rgba(0,0,0,0.03)",
  ...
  return (
    ...
    >
      <div className="max-w-[1000px] mx-auto px-6 md:px-16" ref={reveal.ref}>
        ...
        <div className={`grid grid-cols-1 sm:grid-cols-2 gap-5 md:gap-6 ${reveal.className}`}>
          {items.map((item, i) => (
